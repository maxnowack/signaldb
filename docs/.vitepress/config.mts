...
export default withMermaid({
  ...
  buildEnd: async () => {
    ...
    const redirects = {
      ...
      '/replication/': '/sync/',
      '/replication/appwrite/': '/sync/',
      '/replication/firebase/': '/sync/',
      '/replication/http/': '/sync/',
      '/replication/other/': '/sync/',
      '/replication/rxdb.html': '/sync/',
      '/replication/rxdb/index.html': '/sync/',
      '/replication/supabase/': '/sync/',
      '/sync/reference/': '/reference/sync/',

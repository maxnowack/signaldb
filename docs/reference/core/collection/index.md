...
* options (Optional): An object specifying various options for the collection. Options include:
  ...
  * primaryGenerator: A function that generates a unique ID for the item. The function should return a string or number. If not provided, a default generator will be used.

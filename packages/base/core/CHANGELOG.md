...
* Introduced `beforeInsert` option when creating a `Collection`. This allows specifying a function that will be executed before an item is inserted, enabling custom logic like generating unique IDs.
